      ...
      <div class="max-w-screen-xl mx-auto">
        <div class="lg:columns-2 lg:gap-8">
          ...
          >
            ...
            <div
              class="absolute inset-y-0 hidden w-full -left-full bg-slate-50 lg:block"
            ></div>
            ...
            <div class="relative max-w-2xl mx-auto lg:mx-0 lg:max-w-none">
              ...
              <!-- Contact information -->
              <div
                class="grid gap-8 mt-16 sm:mt-20 sm:grid-cols-2 sm:gap-6 xl:gap-8"
              >
                <!-- Contact 1 -->
                <div class="flex gap-[18px]">
                  <svg
                    ...
                    stroke-width="1.75"
                    stroke="currentColor"
                    class="w-6 h-6 shrink-0 text-sky-600"
                  >
                    <path
                      stroke-linecap="round"
